...
#include "asterisk/res_pjsip_sync_ldap.h"
...
#ifdef GRANDSTREAM_NETWORKS
static int str_to_enabled(const char *value)
{
...
static int set_ldap_param_handler(const struct aco_option *opt, struct ast_variable *var, void *obj)
{
	struct ast_sip_endpoint *endpoint = obj;

	if (NULL == endpoint || NULL == endpoint->ldap_params) {
		return -1;
	}

	endpoint->ldap_params->enabled = str_to_enabled(var->value);

	return 0;
}

static int set_cc_param_handler(const struct aco_option *opt, struct ast_variable *var, void *obj)
{
	struct ast_sip_endpoint *endpoint = obj;

	if (NULL == endpoint || NULL == endpoint->cc_params) {
		return -1;
	}

	if (ast_cc_is_config_param(var->name)) {
		ast_cc_set_param(endpoint->cc_params, var->name, var->value);
	}

	return 0;
}

static int cc_agent_policy_to_str(const void *obj, const intptr_t *args, char **buf)
{
	const struct ast_sip_endpoint *endpoint = obj;
	char  *pvalue = NULL;
	...
	switch (ast_get_cc_agent_policy(endpoint->cc_params)) {
	...
	if (ast_asprintf(buf, "%s", pvalue) == -1) {
		return -1;
	}
...
static int cc_monitor_policy_to_str(const void *obj, const intptr_t *args, char **buf)
{
	const struct ast_sip_endpoint *endpoint = obj;
	char  *pvalue = NULL;
	...
	switch (ast_get_cc_monitor_policy(endpoint->cc_params)) {
...
static int ccbs_avail_timer_to_str(const void *obj, const intptr_t *args, char **buf)
{
	const struct ast_sip_endpoint *endpoint = obj;
	...
	if (ast_asprintf(buf, "%u", ast_get_ccbs_available_timer(endpoint->cc_params)) == -1) {
		return -1;
	}
...
static int ccnr_avail_timer_to_str(const void *obj, const intptr_t *args, char **buf)
{
	const struct ast_sip_endpoint *endpoint = obj;
	...
	if (ast_asprintf(buf, "%u", ast_get_ccnr_available_timer(endpoint->cc_params)) == -1) {
		return -1;
	}
...
static int cc_offer_timer_to_str(const void *obj, const intptr_t *args, char **buf)
{
	const struct ast_sip_endpoint *endpoint = obj;
	...
	if (ast_asprintf(buf, "%u", ast_get_cc_offer_timer(endpoint->cc_params)) == -1) {
		return -1;
	}
...
static int cc_max_agents_to_str(const void *obj, const intptr_t *args, char **buf)
{
	const struct ast_sip_endpoint *endpoint = obj;
	...
	if (ast_asprintf(buf, "%u", ast_get_cc_max_agents(endpoint->cc_params)) == -1) {
		return -1;
	}
	return 0;
}

static int cc_max_monitors_to_str(const void *obj, const intptr_t *args, char **buf)
{
	const struct ast_sip_endpoint *endpoint = obj;
	...
	if (ast_asprintf(buf, "%u", ast_get_cc_max_monitors(endpoint->cc_params)) == -1) {
		return -1;
	}
...
#ifdef GRANDSTREAM_NETWORKS
	ast_sorcery_object_field_register_custom(sip_sorcery, "endpoint", "cc_agent_policy", "never", set_cc_param_handler, cc_agent_policy_to_str, NULL, 0, 0);
	ast_sorcery_object_field_register_custom(sip_sorcery, "endpoint", "cc_monitor_policy", "never", set_cc_param_handler, cc_monitor_policy_to_str, NULL, 0, 0);
	ast_sorcery_object_field_register_custom(sip_sorcery, "endpoint", "ccbs_available_timer", "4800", set_cc_param_handler, ccbs_avail_timer_to_str, NULL, 0, 0);
	ast_sorcery_object_field_register_custom(sip_sorcery, "endpoint", "ccnr_available_timer", "7200", set_cc_param_handler, ccnr_avail_timer_to_str, NULL, 0, 0);
	ast_sorcery_object_field_register_custom(sip_sorcery, "endpoint", "cc_offer_timer", "60", set_cc_param_handler, cc_offer_timer_to_str, NULL, 0, 0);
	ast_sorcery_object_field_register_custom(sip_sorcery, "endpoint", "cc_max_agents", "1", set_cc_param_handler, cc_max_agents_to_str, NULL, 0, 0);
	ast_sorcery_object_field_register_custom(sip_sorcery, "endpoint", "cc_max_monitors", "2", set_cc_param_handler, cc_max_monitors_to_str, NULL, 0, 0);
	ast_sorcery_object_field_register_custom(sip_sorcery, "endpoint", "ldap_sync_enable", "no", set_ldap_param_handler, cc_max_monitors_to_str, NULL, 0, 0);
#endif
...
#ifdef GRANDSTREAM_NETWORKS
	ast_cc_config_params_destroy(endpoint->cc_params);
#endif
...
#ifdef GRANDSTREAM_NETWORKS
	if (!(endpoint->cc_params = ast_cc_config_params_init())) {
		ao2_cleanup(endpoint);
		return NULL;
	}
	//if (!(endpoint->ldap_params = ast_ldap_config_params_init())) {
	//	ao2_cleanup(endpoint);
	//	return NULL;
	//}
